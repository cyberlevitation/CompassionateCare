      ...
      <div className="container mx-auto px-4">
        <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-4 gap-8 mb-12">
          <div>
            <Link href="/">
              <img
                src="/images/super-health-care-logo.png"
                alt="Super Health Care"
                className="h-14 mb-4 bg-white rounded-md p-2"
              />
            </Link>
            <p className="mb-4 opacity-90">
              Providing exceptional home care services across the UK. Our
              dedicated team is committed to enhancing the quality of life for
              those we care for.
            </p>
          ...
          <div>
            ...
            <ul className="space-y-3">
              <li className="flex items-start">
                ...
                <span>
                  201 Hamlet Court Road, Westcliff-on-Sea, Essex, SS0 7EL
                </span>
              </li>
              <li className="flex items-start">
                <Phone className="h-5 w-5 mt-0.5 mr-3 flex-shrink-0" />
                <span>01702333120</span>
              </li>
              <li className="flex items-start">
            ...
            <div className="mt-4 flex items-center">
              <div className="bg-white p-2 rounded-md">
                ...
                <span className="text-primary text-xs font-semibold text-center block mt-1">
                  CQC Registered
                </span>
              </div>
            </div>
